...
type PaymentRequest_CreditCard struct {
	...
	ExpirationMonth uint32 `protobuf:"varint,3,opt,name=expirationMonth,proto3" json:"expirationMonth,omitempty"`
	ExpirationYear  uint32 `protobuf:"varint,4,opt,name=expirationYear,proto3" json:"expirationYear,omitempty"`
...
func (x *PaymentRequest_CreditCard) GetExpirationMonth() uint32 {
	if x != nil {
...
func (x *PaymentRequest_CreditCard) GetExpirationYear() uint32 {
	if x != nil {
...
func (x *PaymentRequest_CreditCard) GetCvv() uint32 {
	if x != nil {
		return x.Cvv
	}
	return 0
...
var file_protofile_payment_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x74, 0x68, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0f, 0x65, 0x78, 0x70, 0x69,
	...
	0x01, 0x28, 0x0d, 0x52, 0x0e, 0x65, 0x78, 0x70, 0x69, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x59,
	0x65, 0x61, 0x72, 0x12, 0x10, 0x0a, 0x03, 0x63, 0x76, 0x76, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d,
